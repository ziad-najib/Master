#!/usr/bin/env python3
"""
E-commerce Backend API Testing Script - Local Testing
Tests all key endpoints for the e-commerce system with Arabic support using localhost
"""
...
def run_all_tests():
    ...
    print(f"\n{'='*80}")
    print("E-COMMERCE BACKEND API TESTING (LOCAL)")
